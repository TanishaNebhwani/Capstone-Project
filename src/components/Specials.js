...
function Specials() {
    return (<div className='lightBg'>
        <div class="header"><h1 className='heading'>Specials !</h1>
            <button role="button">Online Menu</button></div>
        <div className="card-container">
            <div className="card">
                <img className='dish-img' src={dish1}></img>
                <span className="menu-title">
                    <h3>Dish 1 Xyz</h3>
                    <span className="price">$56.7</span>
                </span>
            ...
            <div className="card">
                ...
                <span className="menu-title">
                    <h3>Dish 2 Xyz</h3>
                    <span className="price">$88.7</span>
                </span>
            ...
            <div className="card">
                ...
                <span className="menu-title">
                    <h3>Dish 3 Xyz</h3>
                    <span className="price">$96.7</span>
                </span>
